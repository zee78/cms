...
@section('page-header')
					...
					<div class="page-header">
						<div>
							<h2 class="main-content-title tx-24 mg-b-5">Project</h2>
							<ol class="breadcrumb">
						...
						<div class="btn btn-list">
							...
							<a class="btn ripple btn-secondary" href="{{ url('cro/project/create') }}"><i class="fe fe-download"></i> Add Project</a>
						</div>
					</div>
					<!-- End Page Header -->
@endsection
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="card custom-card">
								<div class="card-body">
									<div>
										<h6 class="card-title mb-1">Projects List</h6>

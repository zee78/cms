						...
						<div class="">
							<div class="row">
								...
								<div class="col-lg-6 form-group">
									...
									<input class="form-control" name="wquipment_name" placeholder="Enter Equipment Name" required="" type="text">
								</div>
								<!-- ****************** employee last name *************** -->
								<div class="col-lg-6 form-group">
							...
							<div class="row">
								...
								<div class="col-lg-6 form-group">
									...
									<input type="text" name="daintenance_date" placeholder="MM/DD/YYYY" class="form-control fc-datepicker" required="">
								</div>
								<!-- ****************** employee phone number *************** -->
								<div class="col-lg-6 form-group">

...
@section('page-header')
					...
					<div class="page-header">
						...
						<div class="btn btn-list">
							...
							<a class="btn ripple btn-secondary" href="{{ url('skincare/vendors/create') }}"><i class="fe fe-download"></i> Add New Vendor</a>
						</div>
					</div>
					<!-- End Page Header -->
@endsection
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="card custom-card">
								<div class="card-body">
									<div>
										<h6 class="card-title mb-1">Vendors</h6>
										...
										<table class="table" id="tblFormulation">
											<thead>
												<tr>
													...
													<th class="wd-25p">Vendor Type</th>

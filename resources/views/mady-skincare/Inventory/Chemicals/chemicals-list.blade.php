...
@section('page-header')
					...
					<div class="page-header">
						...
						<div class="btn btn-list">
							...
							<a class="btn ripple btn-secondary" href="{{ url('/skincare/inventory/chemical/create') }}"><i class="fe fe-download"></i> Add New Chemical</a>
						</div>
					</div>
					<!-- End Page Header -->
@endsection
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="card custom-card">
								<div class="card-body">
									<div>
										<h6 class="card-title mb-1">Batch</h6>
									...
									<div class="table-responsive">
										<table class="table" id="tblChemical">
											<thead>
												<tr>
													<th class="wd-20p">Sr#</th>
													<th class="wd-25p">Chemical Name </th>
													<th class="wd-20p">Stock In hand </th>
													<th class="wd-20p">Unit Cost</th>
													<th class="wd-20p">Quantity Used</th>

													<th class="wd-25p">Usage Detail </th>
													<th class="wd-20p">Quantity Remaining</th>
													<th class="wd-20p">Stock Level</th>
													<th class="wd-20p">Cost Chemicals Used</th>

													<th class="wd-20p">Wastage Amount</th>
													<th class="wd-25p">Wastage Cost  </th>
				...
				<div class="modal-dialog modal-dialog-centered" role="document">
					<div class="modal-content modal-content-demo">
						...
						<form id="deleteData" > 
							@csrf
							 @method('DELETE')
						<input type="hidden" name="chemicalId" id="chemicalId">
...
<!-- ********************** custom js file here *********************** -->
<script src="{{ URL::asset('assets/CustomJs/MadySkincare/Inventory/Chemicals/chemicals-list.js')}}"></script>

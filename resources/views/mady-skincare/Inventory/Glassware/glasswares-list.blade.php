					...
					<div class="row">
						<div class="col-lg-12">
							<div class="card custom-card">
								<div class="card-body">
									<div>
										<h6 class="card-title mb-1">GlassWare</h6>
										...
										<table class="table" id="tblGlassWare">
											<thead>
												<tr>
													...
													<th class="wd-25p">Glassware Name </th>
...
<!-- ********************** custom js file here *********************** -->
<script src="{{ URL::asset('assets/CustomJs/MadySkincare/Inventory/Glassware/glasswares-list.js')}}"></script>

...
@section('page-header')
					...
					<div class="page-header">
						<div>
							<h2 class="main-content-title tx-24 mg-b-5">Equipment</h2>
							<ol class="breadcrumb">
						...
						<div class="btn btn-list">
							...
							<a class="btn ripple btn-secondary" href="{{ url('/skincare/inventory/equipment/create') }}"><i class="fe fe-download"></i> Add New Equipment</a>
						</div>
					</div>
					<!-- End Page Header -->
@endsection
										...
										<table class="table" id="tblEquipment">
											<thead>
												<tr>
													...
													<th class="wd-25p">Equipment Name </th>
													<th class="wd-20p">Equipment Number </th>
													<th class="wd-20p">Functional Status</th>
													<th class="wd-20p">Hours Used</th>

													<th class="wd-25p">Start Time </th>
													<th class="wd-20p">End Time</th>
													<th class="wd-20p">Maintenance Date</th>
				...
				<div class="modal-dialog modal-dialog-centered" role="document">
					<div class="modal-content modal-content-demo">
						...
						<form id="deleteData" > 
							@csrf
							 @method('DELETE')
						<input type="hidden" name="quipmentId" id="quipmentId">
...
<!-- ********************** custom js file here *********************** -->
<script src="{{ URL::asset('assets/CustomJs/MadySkincare/Inventory/Equipment/equipments-list.js')}}"></script>

...
@section('page-header')
					...
					<div class="page-header">
						<div>
							<h2 class="main-content-title tx-24 mg-b-5">Research Tasks</h2>
							<ol class="breadcrumb">
						...
						<div class="btn btn-list">
							...
							<a class="btn ripple btn-secondary" href="{{ url('research/research-task/create') }}"><i class="fe fe-download"></i> Add New Task</a>
						</div>
					</div>
					<!-- End Page Header -->
@endsection
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="card custom-card">
								<div class="card-body">
									<div>
										<h6 class="card-title mb-1">Research Task</h6>
									...
									<div class="table-responsive">
										<table class="table" id="tblResearchTask">
											<thead>
												<tr>
													<th class="wd-20p">Sr#</th>
													<th class="wd-25p">Title</th>
													<th class="wd-25p">Project Type</th>
													<th class="wd-25p">Funder Type</th>
...
<!-- ********************** custom js file here *********************** -->
<script src="{{ URL::asset('assets/CustomJs/Research/ResearchTask/research-task-list.js')}}"></script>

...
@section('page-header')
					...
					<div class="page-header">
						...
						<div class="btn btn-list">
							...
							<a class="btn ripple btn-secondary" href="{{ url('/roles/create') }}"><i class="fe fe-download"></i> Add New Roles</a>
						</div>
					</div>
					<!-- End Page Header -->
@endsection
...
<!-- ********************** custom js file here *********************** -->
<script src="{{ URL::asset('assets/CustomJs/Rback/Roles/roles-list.js')}}"></script>
